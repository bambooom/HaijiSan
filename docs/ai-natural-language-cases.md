...
| 今天总共吃了多少热量，蛋白质吃够了吗                                                                                                                                                                          | command       | nutrition_summary | execute        | Read today's meal records and summarize calories, protein, and vegetable intake  | Real personal nutrition-summary case; should use sheet-backed daily summary with coverage notes |
