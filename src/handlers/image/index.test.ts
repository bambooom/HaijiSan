...
const mocks = vi.hoisted(() => ({
  ...
  createStockDeductionConfirmation: vi.fn(),
}));
...
vi.mock('../../services/confirmation', () => ({
  ...
  createStockDeductionConfirmation: mocks.createStockDeductionConfirmation,
}));
...
import { handleIncomingImage } from './index';
...
describe('handleIncomingImage', () => {
  beforeEach(() => {
    ...
    mocks.createStockDeductionConfirmation.mockImplementation(() => ({
      ...
      telegramResponse: {
        pendingConfirmationId: 'stock_pending_1',
        replyMarkup: {
          inlineKeyboard: [
            [
              {
                text: '确认扣减',
                callbackData: 'stock:confirm:stock_pending_1',
              },
              { text: '取消', callbackData: 'stock:cancel:stock_pending_1' },
              { text: '修正', callbackData: 'stock:edit:stock_pending_1' },
            ],
          ],
        },
      },
